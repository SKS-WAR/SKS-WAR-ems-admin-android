...
public class RankList_45_question_negative extends AppCompatActivity {
...
//    ArrayList<String> markList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rank_list_45_question_negative);



        listview1 = (ListView) findViewById(R.id.mainListview11);
...
//                            Toast.makeText(RankList_45_question.this, lists.size()+" ", Toast.LENGTH_SHORT).show();
                            ...
                            CustomListAdapter45 adapter = new CustomListAdapter45(RankList_45_question_negative.this, lists);
